...
Once the `conda-forge` channel has been enabled, `spacy-model-ca_core_news_sm, spacy-model-da_core_news_sm, spacy-model-de_core_news_sm, spacy-model-el_core_news_sm, spacy-model-en_core_web_sm, spacy-model-es_core_news_sm, spacy-model-fi_core_news_sm, spacy-model-fr_core_news_sm, spacy-model-it_core_news_sm, spacy-model-ko_core_news_sm, spacy-model-lt_core_news_sm, spacy-model-mk_core_news_sm, spacy-model-nb_core_news_sm, spacy-model-nl_core_news_sm, spacy-model-pl_core_news_sm, spacy-model-pt_core_news_sm, spacy-model-ro_core_news_sm, spacy-model-ru_core_news_sm, spacy-model-sv_core_news_sm, spacy-model-xx_ent_wiki_sm, spacy-model-xx_sent_ud_sm, spacy-model-zh_core_web_sm` can be installed with `conda`:

```
conda install spacy-model-ca_core_news_sm spacy-model-da_core_news_sm spacy-model-de_core_news_sm spacy-model-el_core_news_sm spacy-model-en_core_web_sm spacy-model-es_core_news_sm spacy-model-fi_core_news_sm spacy-model-fr_core_news_sm spacy-model-it_core_news_sm spacy-model-ko_core_news_sm spacy-model-lt_core_news_sm spacy-model-mk_core_news_sm spacy-model-nb_core_news_sm spacy-model-nl_core_news_sm spacy-model-pl_core_news_sm spacy-model-pt_core_news_sm spacy-model-ro_core_news_sm spacy-model-ru_core_news_sm spacy-model-sv_core_news_sm spacy-model-xx_ent_wiki_sm spacy-model-xx_sent_ud_sm spacy-model-zh_core_web_sm
```

or with `mamba`:

```
mamba install spacy-model-ca_core_news_sm spacy-model-da_core_news_sm spacy-model-de_core_news_sm spacy-model-el_core_news_sm spacy-model-en_core_web_sm spacy-model-es_core_news_sm spacy-model-fi_core_news_sm spacy-model-fr_core_news_sm spacy-model-it_core_news_sm spacy-model-ko_core_news_sm spacy-model-lt_core_news_sm spacy-model-mk_core_news_sm spacy-model-nb_core_news_sm spacy-model-nl_core_news_sm spacy-model-pl_core_news_sm spacy-model-pt_core_news_sm spacy-model-ro_core_news_sm spacy-model-ru_core_news_sm spacy-model-sv_core_news_sm spacy-model-xx_ent_wiki_sm spacy-model-xx_sent_ud_sm spacy-model-zh_core_web_sm
```

It is possible to list all of the versions of `spacy-model-ca_core_news_sm` available on your platform with `conda`:

```
conda search spacy-model-ca_core_news_sm --channel conda-forge
```

or with `mamba`:

```
mamba search spacy-model-ca_core_news_sm --channel conda-forge
```
...
mamba repoquery search spacy-model-ca_core_news_sm --channel conda-forge

# List packages depending on `spacy-model-ca_core_news_sm`:
mamba repoquery whoneeds spacy-model-ca_core_news_sm --channel conda-forge

# List dependencies of `spacy-model-ca_core_news_sm`:
mamba repoquery depends spacy-model-ca_core_news_sm --channel conda-forge
```
